...
$fn=20; // [60:Low Quality,720:High Quality]
// Fan length/width in mm
// housing_size=80; // [8,17,20,25,30,35,38,40,45,50,60,70,80,90,92,100,110,120,130,140,150,250,360]
// Fan thickness in mm
...
module fan_parametric(housing_size, housing_height, housing_mount_tab_thickness_ratio, fan_blade_count, fan_blade_direction, fan_blade_twist_ratio, fan_blade_thickness, fan_blade_edge_gap, hub_diameter_to_housing_ratio, mount_hole_diameter)
  {
    /* [Hidden] */
  // leave these be unless you know what you're doing
  housing_inner_diameter=housing_size*0.95;
  housing_corner_radii1=housing_size*0.081667;
  housing_corner_radii2=housing_size*0.083333;
  housing_corner_radii3=housing_size*0.085;
  housing_corner_radii4=housing_size*0.001667;
  housing_outer_diameter=housing_size*1.066667;
  housing_mount_tab_thickness=housing_height*housing_mount_tab_thickness_ratio;
  hub_diameter=housing_size*hub_diameter_to_housing_ratio;
  mount_hole_offset=housing_size*0.416667;
  ...
  difference()
    ...
    linear_extrude(height=housing_height, center = true, convexity = 4, twist = 0)
      difference()
        {
        //overall outside
        square([housing_size,housing_size],center=true);
        ...
        translate([-mount_hole_offset,-mount_hole_offset]) circle(r=mount_hole_diameter/2,h=mount_hole_offset+0.2,center=true);
        //Outside Radii
        translate([housing_size/2,housing_size/2]) difference()
          {
